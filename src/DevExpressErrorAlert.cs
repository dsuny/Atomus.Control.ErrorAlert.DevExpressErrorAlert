...
{
    public class DevExpressErrorAlert : IErrorAlert
    {
        ...
        private ErrorIconAlignment errorIconAlignment = ErrorIconAlignment.MiddleRight;

        public DevExpressErrorAlert()
        {
        ...
        public DevExpressErrorAlert(ContainerControl _ContainerControl) : this()
        {
            this.errorProvider = new DXErrorProvider(_ContainerControl);
        }
        ...
        bool Checked(string message, System.Windows.Forms.Control checkBox)
        {
            ...
            if (checkBox is CheckEdit)
                result = ((CheckEdit)checkBox).Checked;
            else
                throw new AtomusException("Not Support Control.");
        ...
        void IErrorAlert.SetError(System.Windows.Forms.Control control, string message)
        {
            ...
            if (control.Dock == DockStyle.Fill)
                control.Margin = new Padding(control.Margin.Left, control.Margin.Top, control.Margin.Right + DXErrorProvider.GetErrorIconInternal(ErrorType.Information).Width, control.Margin.Bottom);
            else
                control.Size = new Size(control.Width, control.Height);
            //control.Size = new Size(control.Width - DXErrorProvider.GetErrorIconInternal(ErrorType.Information).Width, control.Height);
            ...
            if (control is CheckEdit)
                ((CheckEdit)control).CheckedChanged += TextChanged;
            else if (control is SpinEdit)
                ((SpinEdit)control).ValueChanged += TextChanged;
            else
        ...
        bool IErrorAlert.ValueEqual(decimal value, string message, params System.Windows.Forms.Control[] numericUpDowns)
        {
            ...
            result = true;
            foreach (System.Windows.Forms.Control numericUpDown in numericUpDowns)
            {
        ...
        bool ValueEqual(decimal value, string message, System.Windows.Forms.Control numericUpDown)
        {
            ...
            if (numericUpDown is SpinEdit)
                result = ((SpinEdit)numericUpDown).Value == value;
            else
                throw new AtomusException("Not Support Control.");
